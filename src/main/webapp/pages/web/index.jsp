...
">
<link rel="stylesheet" href="../pages/web/lib/weui.min.css">
<link rel="stylesheet" href="../pages/web/css/jquery-weui.css">
<link rel="stylesheet" href="../pages/web/css/style.css">
</head>
<body ontouchstart>
<!--顶部搜索-->
...
<div class='weui-content'>
  ...
  <div class="swiper-container swiper-banner">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><a href="pro_info.html"><img src="../pages/web/upload/ban1.jpg" /></a></div>
      <div class="swiper-slide"><a href="pro_list.html"><img src="../pages/web/upload/ban2.jpg" /></a></div>
      <div class="swiper-slide"><a href="pro_info.html"><img src="../pages/web/upload/ban3.jpg" /></a></div>
      <div class="swiper-slide"><a href="pro_list.html"><img src="../pages/web/upload/ban4.jpg" /></a></div>
    </div>
    <div class="swiper-pagination"></div>
  </div>
  <!--图标分类-->
  <div class="weui-flex wy-iconlist-box">
    <div class="weui-flex__item"><a href="pro_list.html" class="wy-links-iconlist"><div class="img"><img src="../pages/web/images/icon-link1.png"></div><p>精选推荐</p></a></div>
    <div class="weui-flex__item"><a href="pro_list.html" class="wy-links-iconlist"><div class="img"><img src="../pages/web/images/icon-link2.png"></div><p>酒水专场</p></a></div>
    <div class="weui-flex__item"><a href="all_orders.html" class="wy-links-iconlist"><div class="img"><img src="../pages/web/images/icon-link3.png"></div><p>订单管理</p></a></div>
    <div class="weui-flex__item"><a href="Settled_in.html" class="wy-links-iconlist"><div class="img"><img src="../pages/web/images/icon-link4.png"></div><p>商家入驻</p></a></div>
  </div>
  <!--新闻切换-->
  ...
  <div class="wy-Module">
    ...
    <div class="wy-Module-con">
      <div class="swiper-container swiper-jingxuan" style="padding-top:34px;">
        <div class="swiper-wrapper">
          <div class="swiper-slide"><a href="pro_info.html"><img src="../pages/web/upload/jingxuan1.jpg" /></a></div>
          <div class="swiper-slide"><a href="pro_info.html"><img src="../pages/web/upload/jingxuan2.jpg" /></a></div>
          <div class="swiper-slide"><a href="pro_info.html"><img src="../pages/web/upload/jingxuan3.jpg" /></a></div>
          <div class="swiper-slide"><a href="pro_info.html"><img src="../pages/web/upload/jingxuan4.jpg" /></a></div>
          <div class="swiper-slide"><a href="pro_info.html"><img src="../pages/web/upload/jingxuan5.jpg" /></a></div>
          <div class="swiper-slide"><a href="pro_info.html"><img src="../pages/web/upload/jingxuan1.jpg" /></a></div>
        </div>
...
<script src="../pages/web/lib/jquery-2.1.4.js"></script> 
<script src="../pages/web/lib/fastclick.js"></script> 
<script>
  $(function() {
    FastClick.attach(document.body);
  });
</script> 
<script src="../pages/web/js/jquery-weui.js"></script>
<script src="../pages/web/js/swiper.js"></script>
<script>
